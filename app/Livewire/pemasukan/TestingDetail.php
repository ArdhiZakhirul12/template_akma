...
class TestingDetail extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->spp = bank::where('jenis', 'SPP')->select('presentase')->get();
        $this->dpp = bank::where('jenis', 'DPP')->select('presentase')->get();
        $this->tabungan = bank::where('jenis', 'TABUNGAN')->select('presentase')->get();
    ...
    {
        return view('livewire.pemasukan.testing-detail');
    }
}
