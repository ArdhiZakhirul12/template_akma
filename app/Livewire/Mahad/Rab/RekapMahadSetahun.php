...
namespace App\Livewire\Mahad\Rab;
...
class RekapMahadSetahun extends Component
{
    public $uraians;
    ...
    {
        $this->allKategori = kategoriRab::where('jenis_rab','mahad')->get()->pluck('kategori')->toArray();
    ...
    {
        return view('livewire.mahad.rab.rekap-mahad-setahun');
    }
}
