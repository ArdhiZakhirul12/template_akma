...
namespace App\Livewire\Mahad\Pengeluaran;
...
class Pengeluaran extends Component
{
    ...
    {
    $this->pengeluarans = ModelsPengeluaran::with('uraianKegiatan.subKategoriRab.kategori', 'bank')
    ...
    {
        return view('livewire.mahad.pengeluaran.pengeluaran');
    }
}
