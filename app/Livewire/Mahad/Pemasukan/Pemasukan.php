...
namespace App\Livewire\Mahad\Pemasukan;
...
class Pemasukan extends Component
{
    ...
    {
        $this->pemasukans = ModelsPemasukan::with('siswa')->where('kategori','mahad')->get();
    ...
    {
        return redirect()->route('pemasukan.calender', ['id'=>'all','jenis'=>'mahad']);
    }
    ...
    {
        return view('livewire.mahad.pemasukan.pemasukan');
    }
}
