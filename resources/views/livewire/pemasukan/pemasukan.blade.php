    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div>
            <button wire:click="calenderPage"
                class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-green-800">
            ...
            <tbody>
                @foreach ($pemasukans as $item)
                    <tr
                        ...
                        <td style="text-align: left !important">{{ $item->user->name }}</td>
            ...
            <div id="modal-pemasukan-form"
                ...
                <form action="{{ route('pemasukan.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="user_id" id="user_id" class="hidden" required
                            value="{{ auth()->user()->id }}">
                        <input type="text" name="kategori" id="kategori" class="hidden" required
                            value="umum">
                        <input type="text" name="jumlah" id="jumlah" class="hidden" required value="0"
                            oninput="formatRupiah(this)">
                        <input type="text" name="mahad" id="mahad" class="hidden" required value="0"
                            oninput="formatRupiah(this)">
                    </div>
                   ...
                   <div class="flex w-full">
                    ...
                    <div class="mb-4 ms-4 w-1/2">
                        <label for="metode_pembayaran" class="block text-sm font-medium text-gray-400">Metode Pembayaran</label>
...
<script>
    ...
    function setTheDataStruc() {
        ...
        let getJumlah = 'Rp' + document.getElementById('jumlah').value.replace(/\./g, '').replace(/,/g, '.').toString()
            .replace(/\B(?=(\d{3})+(?!\d))/g, '.')
        ...
        document.getElementById('terbilang_print').innerText = jumlahInWords.charAt(0).toUpperCase() + jumlahInWords
            .slice(1) + ' rupiah';
