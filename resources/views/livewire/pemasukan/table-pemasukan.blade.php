    ...
    <div >
        ...
        <div class="p-5 bg-white dark:bg-zinc-700 rounded-lg shadow-md">
            <table class="dataTableClass w-full text-sm text-left text-gray-500 dark:text-gray-400" style="width:100%">
                ...
                <tbody>
                    @foreach ($this->pemasukans_data as $item)
                        <tr
...
{{-- 
    <footer class="bg-gray-200 dark:bg-gray-800 text-center py-4 w-full mt-auto" style="bottom: 0">
        <p class="text-sm text-gray-600 dark:text-gray-400">© {{ now()->year }} Your Company. All rights reserved.</p>
    </footer> --}}
