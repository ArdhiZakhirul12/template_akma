<div>
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        <h1 class="text-3xl font-bold mb-2">Pengeluaran Mahad</h1>
        ...
        @if ($openModal)
            <div id="add-pengeluaran-modal"  onclick="if (event.target === this) closeModal()"
                ...
                <div class="p-6 bg-white dark:bg-zinc-700 rounded-lg shadow-md">
                    ...
                    <form action="{{ route('mahad.pengeluaran.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="text" name="kategori" id="kategori" class="hidden" value="mahad" required>
                            <div class="mb-4 ">
                            ...
                            <input type="text" name="jenis_id" id="jenis_id" class="hidden" value="4"
                            required>
