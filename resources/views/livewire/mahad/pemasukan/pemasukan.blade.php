<div>
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        <h1 class="text-3xl font-bold mb-2">Pemasukan Mahad</h1>
        <div>
            ...
            <tbody>
                @foreach ($pemasukans as $item)
                    <tr
                        ...
                        <td style="text-align: left !important">{{ toRupiah($item->mahad) }}</td>
        ...
        <div id="add-pemasukan-modal" onclick="if (event.target === this) closeModal()"
            ...
            <div id="modal-pemasukan-form"
                ...
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl  font-semibold mb-4">Tambah Pemasukan Mahad</h2>
                    <button onclick="closeModal()" class="text-gray-500 hover:text-gray-100 text-xl">&times;</button>
                </div>
                <form action="{{ route('mahad.pemasukan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        <label for="mahad" class="block text-sm font-medium text-gray-400">Jumlah</label>
                        <input type="text" name="mahad" id="mahad"
                            class="mt-1 p-2 w-full border border-gray-300 rounded" required
                            oninput="formatRupiah(this)">
                    </div>
                    <div class="mb-4">
                   
                        <input type="text" name="kategori" id="kategori" value="mahad"
                            class="mt-1 hidden p-2 w-full border border-gray-300 rounded">
                    </div>
                    <div class="mb-4">
            ...
            <div class="flex items-center justify-center">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="px-4 py-2 text-center text-gray-900 dark:text-white" id="place_date">...., ...
                                bulan 202...</td>
